...
# Mutasjon med self-adaptive mutasjons rate
...
# Evolutionary Strategies (ES) med Self-adaptive mutasjons rate
def advanced_evolutionary_strategies(returns, population_size, num_generations, mutation_rate):
    ...
    for generation in range(num_generations):
        ...
        # Steg 3: Rekombinasjson (genererer offspring ved å rekombinere parents)
        offspring = []
...
# Defineerer parametere for Evolutionary Strategies algoritmer
population_size = 150  
num_generations = 500  
mutation_rate = 0.05  

#  Advanced Evolutionary Strategies (ES)
best_portfolio_es, fitness_history_es = advanced_evolutionary_strategies(
...
# Plot fitness historikk for ES
plt.plot(fitness_history_es)
plt.xlabel('Generation')
plt.ylabel('Best Fitness (Expected Return)')
plt.title('Evolution of Portfolio Expected Return (Advanced ES)')
plt.show()
